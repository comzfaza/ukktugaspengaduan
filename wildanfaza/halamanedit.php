...
<body>
    ...
    <form action="edit.php?id=<?= $data['id_pengaduan']?>" method="POST" enctype= "multipart/from-data">
    <div class="container">
    <div class="mb-3">
    ...
    <textarea class="form-control" id="exampleFormControlTextarea1" name="isi_laporan"
     rows="3" value="<?php echo $data['isi_laporan']?>" required></textarea>
    </div>
    <input class="btn btn-primary" type="submit" value="Submit" value= "kirim">
    </form>
</div>
</body>
</html>